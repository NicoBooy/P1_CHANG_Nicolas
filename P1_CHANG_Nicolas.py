...
def main():
    ...
    parser.add_argument('--xmax', type=float, default=15, help='Upper bound for x (default: 15)')
    parser.add_argument('--ymax', type=float, default=15, help='Upper bound for y (default: 15)')
